...
export function Team() {
  return (
    <div className="bg-white" id="the-team">
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    <div className="text-lg leading-6 font-medium space-y-1">
                      <h3>{person.name}</h3>
                      <p className="text-purple-700">{person.role}</p>
                    </div>
                    <ul className="flex justify-center space-x-5">
                      <li>
                        <a href={person.twitterUrl} className="text-gray-400 hover:text-light-blue-400" target="blank">
                      ...
                      <li>
                        <a href={person.githubUrl} className="text-gray-400 hover:text-black" target="blank">
